...
#define D_C_S(tp, sn, sz, ...) unsigned char INVALID1337##sn[] = { __VA_ARGS__ }; SHELL_RELATIVITY -= sizeof(INVALID1337##sn); tp char sn[sz] = { __VA_ARGS__ } // Double contructs the shellcode to create valid checkpoints
...
#define ADDW_AX_W(w) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x01, 0x05, WORDPTR(w) // add al, w [Size: 0x4]
...
#define ORB_AL_B(b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x01, 0x0C, BYTEPTR(b)) // or al, b [Size: 0x2]
#define ORW_AX_W(w) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x01, 0x0D, WORDPTR(w)) // or al, w [Size: 0x4]
#define ORD_EAX_D(d) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x01, 0x0D, DWORDPTR(d)) // or eax, d [Size: 0x5]
...
#define ADCB_AL_B(b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x01, 0x14, BYTEPTR(b)) // adc al, b [Size: 0x2]
#define ADCW_AX_W(w) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x01, 0x15, WORDPTR(w)) // adc al, w [Size: 0x4]
#define ADCD_EAX_D(d) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x01, 0x15, DWORDPTR(d)) // adc eax, d [Size: 0x5]
...
#define SBBB_AL_B(b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x01, 0x1C, BYTEPTR(b)) // sbb al, b [Size: 0x2]
#define SBBW_AX_W(w) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x01, 0x1D, WORDPTR(w)) // sbb al, w [Size: 0x4]
#define SBBD_EAX_D(d) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x01, 0x1D, DWORDPTR(d)) // sbb eax, d [Size: 0x5]
...
#define ANDB_AL_B(b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x01, 0x24, BYTEPTR(b)) // and al, b [Size: 0x2]
#define ANDW_AX_W(w) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x01, 0x25, WORDPTR(w)) // and al, w [Size: 0x4]
#define ANDD_EAX_D(d) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x01, 0x25, DWORDPTR(d)) // and eax, d [Size: 0x5]
...
#define SUBB_AL_B(b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x01, 0x2C, BYTEPTR(b)) // sub al, b [Size: 0x2]
#define SUBW_AX_W(w) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x01, 0x2D, WORDPTR(w)) // sub al, w [Size: 0x4]
#define SUBD_EAX_D(d) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x01, 0x2D, DWORDPTR(d)) // sub eax, d [Size: 0x5]
...
#define XORB_AL_B(b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x01, 0x34, BYTEPTR(b)) // xor al, b [Size: 0x2]
#define XORW_AX_W(w) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x01, 0x35, WORDPTR(w)) // xor al, w [Size: 0x4]
#define XORD_EAX_D(d) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x01, 0x35, DWORDPTR(d)) // xor eax, d [Size: 0x5]
...
#define CMP_AL_B(b) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x01, 0x3C, BYTEPTR(b)) // xor al, b [Size: 0x2]
#define CMPW_AX_W(w) PFX_WORD, INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x01, 0x3D, WORDPTR(w)) // xor al, w [Size: 0x4]
#define CMPD_EAX_D(d) INSERT_INLINECODE_8_BIT_ARRAY(SHELL_RELATIVITY += 0x01, 0x3D, DWORDPTR(d)) // xor eax, d [Size: 0x5]
