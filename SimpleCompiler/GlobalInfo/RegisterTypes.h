...
public:
	enum Type : unsigned char
	{
		...
		RDX = 2,
		RBX = 3,
		RSP = 4, // Just a bad idea to specify anywhere, you'll most likely end up corrupting the execution
		RBP = 5, // Not recomended for pointer use
		RSI = 6,
		RDI = 7,
		...
		R10 = 2 | x64Extend,
		R11 = 3 | x64Extend,
		R12 = 4 | x64Extend, // Increadibly volatile with dereferencing, requires multiple bytes to use, not recomended
		R13 = 5 | x64Extend, // Less volatile, but still has an annoying trate of dereferencing
		R14 = 6 | x64Extend,
		R15 = 7 | x64Extend,
